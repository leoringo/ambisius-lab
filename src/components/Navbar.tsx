...
const Navbar: React.FC = () => {
    ...
    const isActive = (pathname: string) => {
        ...
        const notActiveTab = "inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-[#7e8fa9] min-h-[35px] min-w-[100px]"
        const activeTab = "inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-white text-black shadow min-h-[25px] min-w-[100px]"
        ...
        <main className="p-6 space-y-5 w-[650px]">
            ...
            <div className="flex justify-between">
                <div className="inline-flex h-10 items-center justify-center rounded-md bg-muted p-1 text-muted-foreground bg-[#f1f5f9]">
                    <Link href="/menu"
                        className={isActive('/menu')}>Menu</Link>
                    <Link href="/order"
                        className={isActive('/order')}>Order</Link>
                    <Link href="/dapur"
                        className={isActive('/dapur')}>Dapur</Link>
                    <Link href="/kasir"
